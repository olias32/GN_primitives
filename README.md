...
Just install and it will show up in the Add - Mesh menu.

You can also go into the script and manually modify the default values for radius, size etc if you need to.
